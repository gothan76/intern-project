...
let rotation = 0;
let scale = 1;
let flipH = 1; // Flip horizontal (1 = normal, -1 = flipped)
let flipV = 1; // Flip vertical (1 = normal, -1 = flipped)
let translateY = 0; // Movement in the Y direction
let translateX = 0; // Movement in the X direction
